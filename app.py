...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        cv2.rectangle(frame, (0,0), (700, 40), (0,0,0), -1)#
        cv2.putText(frame,"Kindly ensure you've placed your ",(5,430),cv2.FONT_HERSHEY_TRIPLEX, 0.7, (25,229,252), 1, cv2.LINE_AA)
        cv2.putText(frame,"HAND INSIDE THE BOX",(5,470),cv2.FONT_HERSHEY_TRIPLEX, 0.7, (25,229,252), 1, cv2.LINE_AA)
        cv2.putText(frame,"OUTPUT: "+' '.join(sentence)+" "+''.join(accuracy)+"%", (5,30), 
